...
import com.example.assignment6.activity.ShowPostsActivity;

import static com.example.assignment6.util.Constants.USERID;
...
public class UserDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button mButton = view.findViewById(R.id.btn_show_posts_fragment_users_details);
        mButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TextView textView = view.findViewById(R.id.tv_user_id_fragment_user_details);
                if (textView.getText() != "") {
                    Intent intent = new Intent(mContext, ShowPostsActivity.class);
                    intent.putExtra(USERID, textView.getText());
                    startActivity(intent);
                } else {
                    Toast.makeText(mContext, "User not selected", Toast.LENGTH_SHORT).show();
                }
